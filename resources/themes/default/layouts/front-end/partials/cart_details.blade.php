		...
		<div class="table-responsive d-none d-lg-block">
            ...
            <div class="cart_information mb-3 pb-3 w-100 d-lg-none">
				...
				<div class="px-3 px-md-0 mb-3">
					<div class="row">
						<div class="col-12">
						    	<label for="phoneLabel" class="form-label input-label">Kindly select your preferred shipping method: <span class="input-label-secondary"> *</span></label>
							<select style="border-color: red !important" id="shipControl" class="form-control border-aliceblue" onchange="set_shipping_id(this.value,'all_cart_group')">
								<option>{{translate('choose_shipping_method')}}</option>
								@foreach($shippings as $shipping)
								<option
    ...
    <script>
        function checkout() {
            ...
            $.post({
                ...
                success: function (data) {
                    let sControl = $('#shipControl').val();
                    window.localStorage.setItem("shippingMethod", sControl);
