	...
	<div class="col-lg-9 col-12">
		...
		<div class="row no-gutters d-none mt-2 flex-start d-flex">
			<div class="col-12">
				...
				<a
				onclick="customRequestOpen()"  class="btn btn--primary element-center" style="width: 100%;"
				type="button">
					<span class="string-limit">Custom Request</span>
				</a>
				<!-- Lumidee workings <a
					class="btn btn--primary element-center btn-gap-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}" style="width: 50%;"
					href="{{route('request')}}" type="button">
					<span class="string-limit">{{translate('Custom Request')}}</span>
				</a>-->
				@else
