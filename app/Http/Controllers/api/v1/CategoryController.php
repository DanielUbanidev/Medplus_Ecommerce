...
class CategoryController extends Controller
{
    ...
    public function get_sub_categories_two($id)
    {
    ...
    {
        return response()->json(Helpers::product_data_formatting(CategoryManager::products($id, $request, $request['limit'], $request['offset']), true), 200);
    }
