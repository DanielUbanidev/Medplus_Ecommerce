...
class ProductDetailsController extends Controller
{
    ...
    public function customview(){
        $request = CustomRequest::all(); 
        return view('web-views.products.request', ['data' => $request]); 
    }
    ...
    public function createCustomRequest(Request $request){
        $validator = Validator::make($request->all(),[
            ...
            'name_of_product' => ['required', 'string'],
        ...
        $customRequest->name_of_customer = $request->name;
        $customRequest->phone_no = $request->phone;
        $customRequest->name_of_product = $request->product;
        $customRequest->quantity = $request->quantity;
        $customRequest->save();

        return back()->with('success', 'Custom request created successfully');
    }
