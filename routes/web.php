...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode','guestCheck']], function () {
    ...
    Route::get('request', 'ProductDetailsController@customview')->name('request');
    // Route::post('CustomRequest', 'ProductDetailsController@createCustomRequest')->name->name('createCustomRequest');
